...
df_2021 = df[df['chartWeek'].dt.year == 2021]


generoContagem = df_2021['musicGenre'].value_counts().reset_index()
...
plt.title("Top 10 Gêneros Musicais Mais Escutados de 2021")


plt.savefig(r"c:\Users\victo\Downloads\top10Genero2021.png", format= 'png', dpi=300, bbox_inches='tight' )
plt.show()
