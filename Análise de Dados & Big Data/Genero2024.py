...
df_2024 = df[df['chartWeek'].dt.year == 2024]


generoContagem = df_2024['musicGenre'].value_counts().reset_index()
...
plt.title("Top 10 Gêneros Musicais Mais Escutados de 2024")


plt.savefig(r"c:\Users\victo\Downloads\top10Genero2024.png", format= 'png', dpi=300, bbox_inches='tight' )
plt.show()
