...
df_2020 = df[df['chartWeek'].dt.year == 2020]


generoContagem = df_2020['musicGenre'].value_counts().reset_index()
...
# Exibir os 10 gêneros mais escutados em 2020
...
plt.title("Top 10 Gêneros Musicais Mais Escutados de 2020")


plt.savefig(r"c:\Users\victo\Downloads\top10Genero2020.png", format= 'png', dpi=300, bbox_inches='tight' )
plt.show()
